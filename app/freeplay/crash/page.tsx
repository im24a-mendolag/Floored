    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Freeplay sandbox for the Crash multiplier game.</p>
        </div>
      ...
      {bankroll > 0 ? (
        <CrashGame mode="freeplay" bankroll={bankroll} onResolve={handleResolve} />
      ) : (
